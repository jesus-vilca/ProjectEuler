...
long long maxcoll(long long);
long int collatz(long long);
long long cCelosia(int);
long int maxstring=0;
int array1[20][20] = 
...
long long sumatoria_nat(long long);
long long triangulo(long int);
int cont_factores(long long);
int compuesto(long int);
/*string *array2[100][] =
...
*/long long primersum(char a[][3]);
char *arrayaux[7][3] = {"123","234","345","456","567","678","789"}; 
...
int main(){
    ...
    cout<<"Ejercicio 10:"<<debprim(2000000)<<endl;
    cout<<"Ejercicio 12: "<<triangulo(500)<<endl;
    */
    //cout<<"Ejercicio 13: "<<primersum(arrayaux)<<endl;
   /*
    cout<<"Ejercicio 14: "<<maxcoll(1000000)<<endl;
    cout<<"Ejercicio 15:"<<cCelosia(20)<<endl;
    cout<<maxcoll(1000)<<endl;*/
    getch();
    return 0;
}
//Ejercicio 1
...
//Ejercicio 10
bool ComprobarPrimo(long num){          //Función eficiente
    long divisores=2;
    bool valor=true;
    if(num<2){
        valor=false;
...
//Ejercicio 12
long long sumatoria_nat(long long n){
    return n*(n+1)/2;
}
int cont_factores(long long n){         //Esta función me la proporcionó Josue Sumare
    int cont=0;     
...
long long triangulo(long int n){
    long long num=1;
    while(cont_factores(sumatoria_nat(num))<=n){
        num+=1;
    }
    return sumatoria_nat(num);
}
//Ejercicio 13
long long primersum(char* a[][3]){
...
//Ejercicio 15
long long cCelosia(int n){                              
    long long var=1,aux=1;
    for(int i=2*n;i>n;i--){
        var*=i;
        if(var%(i-20)==0){
            var/=(i-20);
